...
(setq cat-list-defines
  '(("kate" "kat")
     ...
     ("paypal" "pay")
     ("postoffice\\|endsleigh\\|waste\\|lloyds\\|electric\\|sse\\|newsstand\\|privilege\\|pcc\\|licence\\|ovo\\|energy\\|bt\\|water" "utl")
     ("b365\\|races\\|bet365\\|racing" "bet")
     ...
     ("aqua" "txi")
     ("specsavers\\|publishing\\|anthem\\|kindle\\|news" "rdg")
     ...
     ("finance" "fin")
     ("tvplayer\\|vue\\|sky\\|netflix\\|audible\\|nowtv\\|channel\\|prime" "str")
     ("google" "goo")
     ("platinum\\|card" "crd")
     ("top-up\\|three\\|h3g" "phn")
     ("24pymt\\|champo\\|costa\\|gollo\\|pumpkin\\|argos\\|the-range\\|biffa\\|moonpig\\|apple\\|itunes\\|gold\\|interflora\\|morrison\\|thortful" "shp")
     ("pet" "pet")
     ("residential\\|rent\\|yeong" "rnt")
     ("amaz\\|amz" "amz")
     ("waitrose\\|tesco\\|domino\\|deliveroo\\|just.*eat\\|just eat" "fod")
     (".*" "o")
     ))
