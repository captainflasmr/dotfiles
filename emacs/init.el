...
(define-key my-jump-keymap (kbd "1") (lambda () (interactive)(tab-bar-select-tab 1)))
(define-key my-jump-keymap (kbd "2") (lambda () (interactive)(tab-bar-select-tab 2)))
(define-key my-jump-keymap (kbd "3") (lambda () (interactive)(tab-bar-select-tab 3)))
(define-key my-jump-keymap (kbd "4") (lambda () (interactive)(tab-bar-select-tab 4)))
(define-key my-jump-keymap (kbd "5") (lambda () (interactive)(tab-bar-select-tab 5)))
            ...
            (cond
              ((eq format-spec :hugo)
                (when (= value 1)
                  ...
                  (mapc 'shell-command '("web rsync emacs" "web rsync art" "web rsync dyerdwelling" "web rsync sway"))))
              (t
                (let (exported-file)
                  (pcase format-spec
                    (:ascii
                      (setq exported-file (concat (file-name-sans-extension
