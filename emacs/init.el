...
(define-key my-jump-keymap (kbd "=") 'my/create-tab-with-number)
...
(defun my/tab-bar-mode()
  ...
  (let ((darker-accent-color (color-darken-name my/accent-color 30)))
    (tab-bar-mode 'toggle)
    (tab-rename (number-to-string (length (tab-bar-tabs))))
...
(defun my/create-tab-with-number ()
  "Create a new tab and name it based on its relative position."
  (interactive)
