...
;; (add-hook 'window-configuration-change-hook (lambda () (interactive)(selected-window-accent "#c34444")))
(add-hook 'window-state-change-hook 'selected-window-accent)
;; (add-hook 'window-state-change-hook (lambda () (interactive)(selected-window-accent "#c34444")))
