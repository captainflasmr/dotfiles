...
#+begin_src elisp
   ...
   (use-package hydra
     ...
     (defhydra hydra-jump-to-somewhere
       ...
       ("d" (find-file (concat home-dir "/DCIM/content")) "content")
       ("t" (find-file (concat (concat home-dir "/DCIM/content") "/aaa--todo.org")) "todo")
       ("s" (find-file (concat (concat home-dir "/DCIM/content") "/aaa--source_code.org")) "src")
...
#+begin_src elisp
    ...
    (global-set-key (kbd "C-c d") (lambda()(interactive)(dired (concat home-dir "/DCIM/content"))))
